...
namespace Vereinsmanager.Migrations
{
    ...
    [Migration("20260226093504_AlternateVoice 2FK")]
    partial class AlternateVoice2FK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vereinsmanager.Database.ScoreManagment.AlternateVoice", b =>
                {
                    ...
                    b.HasIndex("AlternativeVoiceId");

                    b.HasIndex("VoiceId", "AlternativeVoiceId")
                        .IsUnique();
